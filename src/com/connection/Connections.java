...
//String c_pwd =request.getParameter("conf_pwd");
		String query = com.constants.QueryConstants.UDINSQUERY + rand + "," + "'" + first_name + "'," + "'" + last_name
				+ "'," + mob_number + "," + gender + "," + "'" + address + "'," + "'" + city + "'," + "'" + p_code
				+ "'," + "'" + state + "'," + "'India'," + "'" + DOB + "')" + ";";
		String query2 = com.constants.QueryConstants.ULINSQUERY + rand + "," + "'" + first_name + "'," + "'" + last_name
				+ "'," + "'" + email_id + "'," + "'" + pwd + "'," + "1)" + ";";
		try {

			Class.forName(com.constants.URLConstants.DATABASEDRIVER);
			Connection connection = DriverManager.getConnection(com.constants.URLConstants.DATABASEURL,
					com.constants.URLConstants.DATABASEUSERNAME, com.constants.URLConstants.DATABASEPASSWORD);
